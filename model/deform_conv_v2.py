...
# -*- coding: utf-8 -*-
'''
# @description: PyTorch implementation of Deformable ConvNets v2
# origin: https://github.com/4uiiurz1/pytorch-deform-conv-v2/blob/master/deform_conv_v2.py
'''
...
if __name__ == "__main__":
    print('test deformable convolution')
    conv = ConvNet()
    x = torch.rand(4, 3, 128, 128)
    y = conv(x)
    print(y.shape)
    import numpy as np
    para = sum([np.prod(list(p.size())) for p in conv.parameters()])
    print('Model {} : params: {:4f}M'.format(conv._get_name(), para * 4 / 1000 / 1000))
